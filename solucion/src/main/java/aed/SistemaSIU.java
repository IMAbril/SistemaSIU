...
// Para cada clave estudiante (LU) en estudiantes:
//      el significado (inscripciones) es igual a la sumatoria de las veces que el estudiante aparece en la lista de inscriptos de las materias del sistema 
//      el significado (inscripciones) está entre 0 y la cantidad de materias del sistema.
// La suma de los significados de todas las claves en estudiantes es igual a la sumatoria de la longitud de la lista de inscriptos de cada materia del sistema.
// Para cada clave carrera en carreras:
//      el significado es una carrera del sistema. 
